...
def parse_args():
    ...
    # basic parameters
    parser.add_argument('--model_name', type=str, default='Sparse_Attn_Logic', help='the name of the model')
    parser.add_argument('--data_name', type=str, default='CWRU', help='the name of the data')
    parser.add_argument('--data_dir', type=str, default= "F:\\Data\\CWRU", help='the directory of the data')
    ...
    parser.add_argument('--batch_size', type=int, default=20, help='batchsize of the training process')
...
if __name__ == '__main__':
    ...
    #args.parse_args('--model_name','LeNet2d')
